...
label kids:
    if defiance > 0 and not dumped and not leftovers:
        ...
        "She opens her mouth. You expected her to squeal{pause}but no sound comes out."
...
label exercise:
    ...
    if heal <= 2:
        "It's rather gnarly{pause}the huge wound on your leg is barely starting to scab. The pain stops you from even contracting the muscles."
        if hunger <= 2:
